...
pub var napi_create_string_utf8: *const @TypeOf(c.napi_create_string_utf8) = c.napi_create_string_utf8;
pub var napi_create_uint32: *const @TypeOf(c.napi_create_uint32) = c.napi_create_uint32;
pub var napi_define_properties: *const @TypeOf(c.napi_define_properties) = c.napi_define_properties;
pub var napi_get_arraybuffer_info: *const @TypeOf(c.napi_get_arraybuffer_info) = c.napi_get_arraybuffer_info;
pub var napi_get_cb_info: *const @TypeOf(c.napi_get_cb_info) = c.napi_get_cb_info;
pub var napi_get_null: *const @TypeOf(c.napi_get_null) = c.napi_get_null;
pub var napi_get_undefined: *const @TypeOf(c.napi_get_undefined) = c.napi_get_undefined;
pub var napi_get_value_string_utf8: *const @TypeOf(c.napi_get_value_string_utf8) = c.napi_get_value_string_utf8;
pub var napi_throw_error: *const @TypeOf(c.napi_throw_error) = c.napi_throw_error;

const kernel32 = std.os.windows.kernel32;
const is_windows = builtin.target.os.tag == .windows;
var windows_handle: ?std.os.windows.HMODULE = null;
fn load_sym(comptime T: type, name: []const u8) T {
    return @ptrCast(kernel32.GetProcAddress(windows_handle.?, name.ptr).?);
}
